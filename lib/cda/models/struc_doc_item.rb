class Cda::StrucDocItem < Cda::Base
  ...
  attribute :paragraph, Array[Cda::StrucDocParagraph], annotations: {:multiple=>true}
  attribute :list, Array[Cda::StrucDocList], annotations: {:multiple=>true}
  attribute :table, Array[Cda::StrucDocTable], annotations: {:multiple=>true}
